...
class DaysMenu extends Phaser.Scene {
    ...
    preload() {
        this.load.image(
            'button',
            '/static/assets/images/menu/dayOneButton.png'
        );
        this.load.image(
            'background',
            '/static/assets/images/menu/mainMenuBackground.jpg'
        );
    }
    create() {
        ...
        axios
            ...
            .then((response) => {
                ...
                const day1 = new Button(
                    xbutton,
                    ybutton1,
                    'button',
                    this,
                    () => {
                        this.chargeDay(dayKey, response.data);
                    },
                    1.5
                );
            })
...
export class MainMenu extends Phaser.Scene {
    ...
    preload() {
        this.load.image(
            'searchIcon',
            '/static/assets/images/utils/searchIcon.png'
        );
        this.load.image(
            'background',
            '/static/assets/images/menu/menuBackground.png'
        );
        this.load.image(
            'playbutton',
            '/static/assets/images/menu/playButton.png'
        );
        this.load.image(
            'dayOneButton',
            '/static/assets/images/menu/dayOneButton.png'
        ...
        this.load.image(
            'transitionIcon',
            '/static/assets/images/utils/transitionIcon.png'
        );
        this.load.image(
            'blackBanner',
            '/static/assets/images/utils/blackBanner.png'
        );
        this.load.image(
            'menuLabel',
            '/static/assets/images/utils/menuLabel.png'
        );
        this.load.image(
            'levelLabel',
            '/static/assets/images/menu/levelLabel.png'
        );
        this.load.image(
            'itemFrame',
            '/static/assets/images/utils/itemRectangle.png'
        );
        this.load.image(
            'itemGroup',
            '/static/assets/images/utils/itemGroup.png'
        );
    ...
    create() {
        ...
        const playButton = new Button(
            ...
            this,
            () => {
                this.chargeScene(DaysMenu, 'DaysMenu');
            },
            1.5
        );
    }
